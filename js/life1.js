$(function () {
    ...
    $(".list_item-one").mouseenter(function () {
        ...
        $(".preview_img img").attr("src", "images/life/nike1.jpg");
    })
    $(".list_item-two").mouseenter(function () {
        $(this).css("border", "1px solid #000");
        $(this).siblings("li").css("border", "1px solid #fff");
        $(".preview_img img").attr("src", "images/life/nike2.jpg");
    })
    $(".list_item-three").mouseenter(function () {
        ...
        $(this).css("border", "1px solid #000");
        $(this).siblings("li").css("border", "1px solid #fff");
        $(".preview_img img").attr("src", "images/life/nike3.jpg");
    })
    $(".list_item-four").mouseenter(function () {
        $(this).css("border", "1px solid #000");
        $(this).siblings("li").css("border", "1px solid #fff");
        $(".preview_img img").attr("src", "images/life/nike4.jpg");
    })
    var  x=1;
    var  y=100;
